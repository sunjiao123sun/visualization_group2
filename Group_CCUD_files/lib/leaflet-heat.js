...
!function () {
 ...
 修改生成的热度图canvas在leaflet svg容器前，以解决压盖无法点击数据源点问题，by zq 2016/3/8
 值渲染时的问题，by zq 2016/5/11
 */
    L.HeatLayer = (L.Layer ? L.Layer : L.Class).extend({
        initialize: function (t, i) {
            ...
            this._map = t, this._canvas || this._initCanvas(), t._panes.overlayPane.insertBefore(this._canvas, t._panes.overlayPane.firstChild), t.on("moveend", this._reset, this), t.options.zoomAnimation && L.Browser.any3d && t.on("zoomanim", this._animateZoom, this), this._reset()
        }, onRemove: function (t) {
            ...
            t.style.opacity = this.options.opacity;
            ...
            for (t = 0, i = this._latlngs.length; i > t; t++)if (a = this._map.latLngToContainerPoint(this._latlngs[t]), m.contains(a)) {
                ...
                if (this._latlngs[t][2] !== undefined) {
                    f = 1;
                }
